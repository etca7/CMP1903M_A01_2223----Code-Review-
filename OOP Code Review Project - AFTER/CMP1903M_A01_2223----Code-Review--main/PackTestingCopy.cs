...

{
    class Pack : Card
    {
        ...
        public void setUpDeck()
        {
            ...
            // The pack is shuffled based on user input, the validInput bool creates a loop that runs as long as the input is valid.
            ...
            while (numberOfCards > 0)
            {
                ...
                else if (dealNumber == 2)
                {
                    ...
                    while (!validInput)
                    {
                        ...
                        {
                            Console.WriteLine("Invalid input. Please enter a positive integer that is not greater than the number of remaining cards.");
                        }
                    }
                }
...

        {
            ...
            // then the for loop is used to run the method multiple times to ensure better randomisation
